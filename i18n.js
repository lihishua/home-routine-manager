...
const TRANSLATIONS = {
    he: {
        ...
        wellDoneNoon: 'כל הכבוד {name}! <br> כל מטלות הצהריים בוצעו!',
        ...
        trophyToggleLabel: 'גביע יומי',
        tooltipTrophy: 'כשמופעל - ילד שמבצע את משימות השגרה שלו באופן רצוף - מקבל גביע לעמודו האישי, ושומר עליו כל עוד לא נשבר הרצף.',
        tooltipSavePastEvents: 'כשמופעל — אירועים שתאריכם עבר ישמרו ברשימה',
    ...
    en: {
        ...
        trophyToggleLabel: 'Daily trophy',
        tooltipTrophy: 'When on — a child who completes all their routine tasks consistently earns a trophy on their personal page, and keeps it as long as the streak is not broken.',
